...
public class SpringBatchConfig {
    ...
    public FlatFileItemReader<Talibe> reader() {
        ...
        reader.setLineMapper(new DefaultLineMapper<Talibe>() {{
            setLineTokenizer(new DelimitedLineTokenizer() {{
                setNames(new String[] {"prenom", "nom","email", "isDieuwrigneDaara","isPercepteur", "idDaara", "sass", "realMagal"});
            }});
    ...
    public JdbcBatchItemWriter<Talibe> writer() {
        ...
        writer.setSql("INSERT INTO TALIBE (PRENOM,NOM,EMAIL,IS_DIEUWRIGNE_DAARA,IS_PERCEPTEUR,DAARA,SASS,REALMAGAL) " +
                "VALUES (:prenom, :nom,:email, :isDieuwrigneDaara, :isPercepteur, :idDaara, :sass, :realMagal)" + "ON DUPLICATE KEY UPDATE "
        		+ " PRENOM=:prenom,"
        		+ " NOM=:nom, "
        		+ " EMAIL=:email ");
